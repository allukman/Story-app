...
class StoryPagingSource(private val apiService: ApiService): PagingSource<Int, DetailStory>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, DetailStory> {
        return try {
            ...
            val responseData = apiService.getAllStoriesPagination(page, params.loadSize)
